...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/food-and-dining/forkable/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("FORKABLE_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "forkable-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
