...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/concur/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("CONCUR_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "concur-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
