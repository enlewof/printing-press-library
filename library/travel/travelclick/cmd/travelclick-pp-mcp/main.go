...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/travel/travelclick/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("TRAVELCLICK_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "travelclick-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
